    ...
    <div class="form-contain">
        ...
        <div class="form-contain-input input-salary">
            ...
            <div class="input-item">
                ...
                <input type="number" class="input" name="taxable" value="{{ $money }}" min="1" max="9999999999">
            </div>
            @error('taxable')
        ...
        <div class="form-contain-input input-salary input-where">
            ...
            <div class="input-item">
                <select class="input-adress" name="country" id="">
                    <option value="America" @if(old('country', $country) === 'America') selected @endif>Mỹ</option>
                    <option value="Anh" @if(old('country', $country) === 'Anh') selected @endif>Anh</option>
                    <option value="Canada" @if(old('country', $country) === 'Canada') selected @endif>Canada</option>
                    <option value="Australia" @if(old('country', $country) === 'Australia') selected @endif>Australia</option>
                </select>
            </div>
        </div>
                ...
                <div class="first-content-container-bottom-contain" style="display: flex; justify-content: space-between; flex-wrap: wrap;">
                    ...
                    <div class="deduction-item-card item-card-active">
                        ...
                        <div class="item-card-value">
                            @if($country == 'America')
                            {{ number_format($money * 24385,0,',',',' )}} ₫
                            @elseif ($country == 'Anh')
                            {{ number_format($money * 29497,0,',',',' )}} ₫
                            @elseif ($country == 'Canada')
                            {{ number_format($money * 17813,0,',',',' )}} ₫
                            @elseif ($country == 'Australia')
                            {{ number_format($money * 15431,0,',',',' )}} ₫
                            @endif
                        </div>
                    </div>
